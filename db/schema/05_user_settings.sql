...
-- 05_user_settings.sql — mirrors supabase/table_user_settings.sql
--                        + add_live_trade_sound_thresholds.sql
--                        + add_positive_gauge_percent_max.sql
--                        + add_per_trade_gauge_auto_close.sql
--                        (live: 12 rows, 35 columns, verified 2026-09-18)
-- ============================================================================
-- PRIMARY KEY IS user_id — this table has NO id column (the application's
-- settings upsert uses onConflict: 'user_id').
--
-- The retired columns daily_target_auto_close_enabled, per_trade_target_percent
-- and sound_notifications_threshold are intentionally NOT created (they are
-- absent from the live table; see supabase/drop_*.sql).
-- ============================================================================
...
create table if not exists public.user_settings (
  ...
  constraint user_settings_default_account_id_fkey foreign key (default_account_id)
