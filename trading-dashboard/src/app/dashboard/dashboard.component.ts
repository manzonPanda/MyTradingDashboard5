  ...
  generateTradingChartData(): void {
      ...
      this.chartData = {
        ...
        datasets: [
          ...
          },
          {
            ...
            data: [startingBalance * (1 + this.profitTargetPercentage / 100)],
          ...
          },
          {
            ...
            data: [startingBalance * (1 - this.maxLossPercentage / 100)],
            borderColor: 'rgb(239, 68, 68)',
            backgroundColor: 'transparent',
            borderWidth: 3,
            borderDash: [6, 6],
    ...
    this.chartData = {
      ...
      datasets: [
        ...
        {
          label: `🔴 --- Max loss (${this.maxLossPercentage}%)`,
          data: new Array(labels.length).fill(startingBalance * (1 - this.maxLossPercentage / 100)),
          borderColor: 'rgb(239, 68, 68)',
          backgroundColor: 'transparent',
          borderWidth: 3,
          borderDash: [6, 6],
