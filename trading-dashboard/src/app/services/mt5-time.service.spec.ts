...
import { Mt5TimeService, mt5ServerTimeToPhilippine, normalizeMt5ServerTime, utcTimeToMt5ServerTime, utcTimeToPhilippine } from './mt5-time.service';
...
describe('Mt5TimeService', () => {
  ...
  it('converts a UTC fallback timestamp into MT5 server wall-clock time', () => {
    expect(utcTimeToMt5ServerTime('2026-07-31 19:42:21')).toBe('2026-07-31 22:42:21');
  });
